...
extern EIF_TYPED_VALUE F1278_11522(EIF_REFERENCE);
extern void F1278_11523(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1278_11522 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1278_11523 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1277, Current, 0, 0, 18280);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1277, Current, 18280);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8368, 0xF800058A, 0); /* implementation */
