...
extern void F1464_14231(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1464_14232(EIF_REFERENCE);
static EIF_TYPED_VALUE F1464_14233_body(EIF_REFERENCE);
...
void F1464_14231 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1463, Current, 0, 1, 20513);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1463, Current, 20513);
	RTCC(arg1, 1463, l_feature_name, 1, RTWCT(9303, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1464_14232 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1463, Current, 1, 0, 20514);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5794, 966))(Current)).it_p);
	RTHOOK(3);
	up1 = loc1;
	...
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9298, 1462))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
static EIF_TYPED_VALUE F1464_14233_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1464_14233 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9303, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1464_14233_body (Current)).it_r;
