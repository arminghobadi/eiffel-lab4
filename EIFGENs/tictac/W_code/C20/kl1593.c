...
extern EIF_TYPED_VALUE F1593_8700(EIF_REFERENCE);
extern void F1593_8701(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1593_8702(EIF_REFERENCE);
...
/* {KL_LINKABLE}.right */
EIF_TYPED_VALUE F1593_8700 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1593_8701 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1592, Current, 0, 1, 14993);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1592, Current, 14993);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6528, 0xF8000638, 0); /* right */
	RTAR(Current, arg1);
...
void F1593_8702 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1592, Current, 0, 0, 14994);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1592, Current, 14994);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6528, 0xF8000638, 0); /* right */
	*(EIF_REFERENCE *)(Current + RTWA(6528, dtype)) = (EIF_REFERENCE) NULL;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
