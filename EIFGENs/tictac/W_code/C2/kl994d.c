...
static const EIF_TYPE_INDEX egt_13_994 [] = {0xFF01,1191,0xFFFF};
static const EIF_TYPE_INDEX egt_14_994 [] = {0xFF01,1160,0xFFFF};
...
static const struct desc_info desc_994[] = {
	...
	{EIF_GENERIC(egt_13_994), 14779, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_994), 14780, 0xFFFFFFFF},
};
void Init994(void)
{
	IDSC(desc_994, 0, 993);
	IDSC(desc_994 + 1, 1, 993);
	IDSC(desc_994 + 32, 871, 993);
}
