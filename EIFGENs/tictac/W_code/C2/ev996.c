...
extern EIF_TYPED_VALUE F996_8469(EIF_REFERENCE);
static EIF_TYPED_VALUE F996_8470_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F996_8470(EIF_REFERENCE);
...
EIF_TYPED_VALUE F996_8469 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 995, Current, 1, 0, 14782);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(995, Current, 14782);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6305, 0xF8000473, 0); /* item_select_actions_internal */
		RTAR(Current, Result);
		*(EIF_REFERENCE *)(Current + RTWA(6305, dtype)) = (EIF_REFERENCE) RTCCL(Result);
	}
	if (RTAL & CK_ENSURE) {
		RTHOOK(5);
...
static EIF_TYPED_VALUE F996_8470_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 995, Current, 0, 0, 14783);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(995, Current, 14783);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F996_8470 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(6305,Dtype(Current)));
	if (!r.it_r) {
		if (RTAT(RTWCT(6305, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F996_8470_body (Current)).it_r;
