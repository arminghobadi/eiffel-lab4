...
extern EIF_TYPED_VALUE F991_8445(EIF_REFERENCE);
...
RTOID (F991_8445)
EIF_TYPED_VALUE F991_8445 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 990, Current, 0, 0, 14758);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(990, Current, 14758);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 990, Current, 0, 0, 14759);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(990, Current, 14759);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
