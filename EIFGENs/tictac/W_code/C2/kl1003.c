...
extern EIF_TYPED_VALUE F1003_8562(EIF_REFERENCE);
...
RTOID (F1003_8562)
EIF_TYPED_VALUE F1003_8562 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1002, Current, 0, 0, 14859);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1002, Current, 14859);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
