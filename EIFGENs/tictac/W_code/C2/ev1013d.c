...
static const EIF_TYPE_INDEX egt_14_1013 [] = {0xFF01,1151,0xFFFF};
...
static const struct desc_info desc_1013[] = {
	...
	{EIF_GENERIC(egt_13_1013), 14903, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1013), 14904, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1013), 14905, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x08F3 /*1145*/), 14906, 0},
	{EIF_NON_GENERIC(0x08FF /*1151*/), 14907, 8},
	{EIF_NON_GENERIC(0x08F3 /*1145*/), 14902, 16},
};
void Init1013(void)
{
	IDSC(desc_1013, 0, 1012);
	IDSC(desc_1013 + 1, 1, 1012);
	IDSC(desc_1013 + 32, 732, 1012);
}
