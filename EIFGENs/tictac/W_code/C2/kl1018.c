...
extern EIF_TYPED_VALUE F1018_8634(EIF_REFERENCE);
...
RTOID (F1018_8634)
EIF_TYPED_VALUE F1018_8634 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1017, Current, 0, 0, 14923);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1017, Current, 14923);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
