...
extern void F1174_10296(EIF_REFERENCE);
...
void F1174_10296 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1173, Current, 0, 0, 16933);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ur1 = RTCCL(tr3);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(6636, Dtype(tr2)))(tr2, ur1x);
	RTNHOOK(1,2);
	ur1 = RTCCL(tr2);
