...
extern void F1176_10299(EIF_REFERENCE);
...
/* {ETF_UNDO}.undo */
void F1176_10299 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1175, Current, 0, 0, 16935);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTNHOOK(1,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(6685, "undo_action", tr1))(tr1);
	RTHOOK(2);
