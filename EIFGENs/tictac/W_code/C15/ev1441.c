...
extern void F1441_13862(EIF_REFERENCE);
static EIF_TYPED_VALUE F1441_13866_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1441_13866(EIF_REFERENCE);
...
/* {EV_TREE_I}.make */
void F1441_13862 (EIF_REFERENCE Current)
{
	GTCX
...
/* {EV_TREE_I}.interface */
static EIF_TYPED_VALUE F1441_13866_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1440, Current, 0, 0, 20266);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1440, Current, 20266);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1441_13866 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9303, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1441_13866_body (Current)).it_r;
