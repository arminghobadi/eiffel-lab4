...
extern void F1428_13604(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1428_13605(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1428_13606(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1428_13607(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1428_13608(EIF_REFERENCE);
extern void F1428_13609(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1428_13610_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1428_13610(EIF_REFERENCE);
...
void F1428_13604 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1427, Current, 0, 1, 20045);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1427, Current, 20045);
	RTCC(arg1, 1427, l_feature_name, 1, RTWCT(9303, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
/* {EV_CELL_IMP}.make */
void F1428_13605 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1427, Current, 0, 0, 20046);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1427, Current, 20046);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_CELL_IMP}.has */
EIF_TYPED_VALUE F1428_13606 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1427, Current, 0, 1, 20047);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1427, Current, 20047);
	RTCC(arg1, 1427, l_feature_name, 1, RTWCT(10368, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_CELL_IMP}.count */
EIF_TYPED_VALUE F1428_13608 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1427, Current, 0, 1, 20043);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1427, Current, 20043);
	RTCC(arg1, 1427, l_feature_name, 1, RTWCT(10368, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(10268, 1410))(Current, ur1x);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10368, 0xF80004F7, 0); /* item */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(10368, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
static EIF_TYPED_VALUE F1428_13610_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1427, Current, 0, 0, 20044);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1427, Current, 20044);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1428_13610 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9303, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1428_13610_body (Current)).it_r;
