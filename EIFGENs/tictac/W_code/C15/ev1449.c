...
static EIF_TYPED_VALUE F1449_13944_body(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1449_13944_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1449_13944 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9303, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1449_13944_body (Current)).it_r;
...
EIF_TYPED_VALUE F1449_13945 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1448, Current, 0, 0, 20301);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1448, Current, 20301);
	RTIV(Current, RTAL);
	RTHOOK(1);
