...
extern EIF_TYPED_VALUE F1154_10132(EIF_REFERENCE);
...
RTOID (F1154_10132)
EIF_TYPED_VALUE F1154_10132 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1153, Current, 0, 0, 16775);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1153, Current, 16775);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
