...
extern EIF_TYPED_VALUE F1153_10131(EIF_REFERENCE);
...
RTOID (F1153_10131)
EIF_TYPED_VALUE F1153_10131 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1152, Current, 0, 0, 16774);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1152, Current, 16774);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
