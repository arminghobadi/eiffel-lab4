...
extern void F1129_9975(EIF_REFERENCE);
extern void F1129_9976(EIF_REFERENCE);
extern void F1129_16348(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1129_9974 (EIF_REFERENCE Current)
{
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7654, Dtype(Current)))(Current)).it_i4);
...
/* {ROOT}.add_tests */
void F1129_9975 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1128, Current, 0, 0, 16338);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1128, Current, 2, 0, 16339);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
		...
		switch (ti4_1) {
			case 1L:
				...
				if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 0L))) {
					...
					RTHOOK(10);
					(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(6788, dtype))(Current);
					RTHOOK(11);
...
/* {ROOT}._invariant */
void F1129_16348 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1128, Current, 0, 16347);
	RTSA(dtype);
	RTME(dtype, 0);
