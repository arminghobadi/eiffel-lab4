...
extern EIF_TYPED_VALUE F1329_12086(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1329_12087(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1329_12088(EIF_REFERENCE);
extern void F1329_12089(EIF_REFERENCE);
extern void F1329_12090(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1329_12091(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1329_12092(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1328, Current, 0, 1, 18849);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1328, Current, 18849);
	{
...
EIF_TYPED_VALUE F1329_12086 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1328, Current, 0, 0, 18850);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1328, Current, 18850);
	RTIV(Current, RTAL);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1328, Current, 1, 0, 18851);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1328, Current, 18851);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
EIF_TYPED_VALUE F1329_12088 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1328, Current, 1, 0, 18852);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1328, Current, 18852);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_destroyed", EX_PRE);
...
void F1329_12089 (EIF_REFERENCE Current)
{
	GTCX
...
body:;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8368, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(2,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(10574, "clear_selection", tr1))(tr1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
void F1329_12090 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1328, Current, 1, 1, 18845);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1328, Current, 18845);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,280,0xFF01,228,217,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
...
EIF_TYPED_VALUE F1329_12091 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1328, Current, 0, 0, 18846);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1328, Current, 18846);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (tb2) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8373, 1569))(Current)).it_b);
		tb1 = tb2;
	}
...
EIF_TYPED_VALUE F1329_12092 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1328, Current, 0, 1, 18847);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1328, Current, 18847);
	RTCC(arg1, 1328, l_feature_name, 1, eif_new_type(1308, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
