...
extern void F1298_11780(EIF_REFERENCE);
...
void F1298_11780 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1297, Current, 0, 0, 18537);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1297, Current, 18537);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8368, 0xF80005A6, 0); /* implementation */
