...
extern EIF_TYPED_VALUE F1317_11962(EIF_REFERENCE);
extern void F1317_11963(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1317_11962 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1317_11963 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1316, Current, 0, 0, 18721);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1316, Current, 18721);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8368, 0xF80005CE, 0); /* implementation */
