...
extern EIF_TYPED_VALUE F1394_13190(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1394_13190 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1393, Current, 0, 0, 19727);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1393, Current, 19727);
	RTIV(Current, RTAL);
	RTHOOK(1);
