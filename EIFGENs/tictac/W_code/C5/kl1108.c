...
EIF_TYPED_VALUE F1108_9443 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1107, Current, 2, 2, 15666);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1107, Current, 15666);
	if (arg1) {
		RTCC(arg1, 1107, l_feature_name, 1, eif_new_type(231, 0x00), 0x00);
	}
	if (arg2) {
		RTCC(arg2, 1107, l_feature_name, 2, eif_new_type(231, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	if (RTCEQ(arg1, arg2)) {
