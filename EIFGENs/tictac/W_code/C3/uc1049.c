...
extern EIF_TYPED_VALUE F1049_9035(EIF_REFERENCE);
...
RTOID (F1049_9035)
EIF_TYPED_VALUE F1049_9035 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1048, Current, 0, 0, 15300);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
