...
extern EIF_TYPED_VALUE F983_8406(EIF_REFERENCE);
static EIF_TYPED_VALUE F983_8407_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_8407(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_8408(EIF_REFERENCE);
static EIF_TYPED_VALUE F983_8409_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F983_8409(EIF_REFERENCE);
...
EIF_TYPED_VALUE F983_8406 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 982, Current, 1, 0, 14722);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 14722);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6241, 0xF800047F, 0); /* select_actions_internal */
		RTAR(Current, Result);
...
static EIF_TYPED_VALUE F983_8407_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 14723);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(982, Current, 14723);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F983_8407 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6241, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F983_8407_body (Current)).it_r;
...
EIF_TYPED_VALUE F983_8408 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 982, Current, 1, 0, 14724);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 14724);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6243, 0xF800047F, 0); /* deselect_actions_internal */
		RTAR(Current, Result);
...
static EIF_TYPED_VALUE F983_8409_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 14725);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(982, Current, 14725);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F983_8409 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6243, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F983_8409_body (Current)).it_r;
