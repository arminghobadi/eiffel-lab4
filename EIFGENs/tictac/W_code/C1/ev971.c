...
#define up1 up1x.it_p
	...
	RTCC(arg1, 970, l_feature_name, 1, eif_new_type(1300, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6093, 0xF8000514, 0); /* pixmap */
	RTAR(Current, arg1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6091, 0xF80004B2, 0); /* target */
	RTAR(Current, arg1);
